		...
		<tbody>
			...
			foreach ($lesParticipations as $uneParticipation) {
				echo "<tr> 
						...
						<td>
							<a href='index.php?page=3&action=sup&idutilisateur&action=sup&id_activite=".$uneParticipation['idutilisateur']."'>
							<img src ='lib/images/sup.png' height='30' witdh='30'> </a>

							<a href='index.php?page=3&action=edit&idutilisateur&action=sup&id_activite=".$uneParticipation['idutilisateur']."'>
